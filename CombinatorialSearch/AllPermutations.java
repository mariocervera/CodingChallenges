...
public class AllPermutations {
	 ...
	 * search space. Each of these solutions represents a permutation. At each step in the backtracking
	 * algorithm, a single character is added to the solution string. This recursive approach implicitly builds
	 * a tree-based search space that is traversed using Depth-First Search. In this tree, the internal nodes
	 * represent partial solutions and the leaves represent complete solutions (permutations).
	 * 
	 *****************************************************************************************************/ 
